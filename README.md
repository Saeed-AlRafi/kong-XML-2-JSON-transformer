...
run:
```
docker build    --build-arg KONG_BASE="kong:3.3"    --build-arg PLUGINS="bundled,xml-json-transformer"    --tag "ekong2" . to build the container using the dockerfile provided to install 
```
dependencies for the XML2JSON plugin.
